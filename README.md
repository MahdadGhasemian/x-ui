...
```
bash <(curl -Ls https://raw.githubusercontent.com/MahdadGhasemian/x-ui/master/install.sh)
```

## Manual installation & upgrade

1. First from https://github.com/MahdadGhasemian/x-ui/releases Download the latest compressed package, generally choose `amd64` architecture
...
![](media/cloudfalre-api-key-1.png)
![](media/cloudfalre-api-key-2.png)
